...
ACCESS_TOKEN 	= ""
ROOM_NAME		= "DNE Mission"
YOUR_MESSAGE 	= "Congratulations on completing the mission"
...
def findRoom(the_header,room_name):
	...
	for room in resp["items"]:
		if room["title"] == room_name:
			print("==========")
			print("We're in the findRoom function.  We'll return the roomId if it exists")
			print("==========")
...
def createRoom(the_header,room_name):
	...
	if roomId==None:
		...
		print("")
		print("==========")
		print("We're in the createRoom function.  We'll return the roomId of the newly created room")
		print("===========")
...
def addMembers(the_header,roomId):
	...
	print("")
	print("==========")
	print("We're in the addMembers function.  This will add the test@test member to the room")
	print("==========")
	#print()
...
def postMsg(the_header,roomId,message):
	...
	print("")
	print("==========")
	print("We're in the postMsg function.  This will post the message to the room")
	print("==========")
	#print()
...
if __name__ == '__main__':
	...
	print("")
	print("==========")
	print("We're in main() now.  Everything should be successful.")
	print("==========")
	print("")
